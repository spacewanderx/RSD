...
# RSD parameters
parser.add_argument('--rsd-stage', default=-1, type=int)
parser.add_argument('--rsd-loss-weight', default=0.1, type=float)
parser.add_argument('--rsd-kappa', default=0.01, type=float)
parser.add_argument('--rsd-gamma', default=2, type=int)
...
def main():
    ...
    if args.dataset == 'cifar100':
        if args.distiller == 'crd':
            ...
            dataset_train = torchvision.datasets.CIFAR100(args.data_dir, train=True, download=args.dataset_download)
